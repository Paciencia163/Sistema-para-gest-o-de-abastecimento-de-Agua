        ...
        $queryfire = mysqli_query($con, $query);
			...
			?>
					<tr>
						...
						<td> <button class="btn" style="background-color: #1159B7;"> <a href="qdelete.php?id=<?php echo $user['id']; ?>" class="text-white">Entregue</a>  </button> </td>
					</tr>
					<?php
					   break;}
					}
