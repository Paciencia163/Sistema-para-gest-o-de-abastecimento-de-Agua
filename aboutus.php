...
<div class="w3-card-4" align="center" style="margin-top: 10px;">
  <img src="admin.jpg" alt="Alpes" height="250px">
  <div class="w3-container w3-center">
    <h4>Proprietário / Desenvolvedor</h4>
  </div>
</div>
<div class="w3-card-4">

<header class="w3-container w3-blue">
  <h1 style="text-align: center;">Devendra Kumar</h1>
</header>

<div class="w3-container" style="margin: 10px;">
  <p>Eu sou Devendra Kumar. Sou do distrito de Basti, Uttar Pradesh.</p>
</div>
            ...
            <div class="col-sm-12">
                <div class="copy-right-bottom" style="color: white;">
                    ...
                    <ul class="f-menu" style="list-style-type:none">
                        <li><a href="termsncon.php">Termos e Condições</a></li>
